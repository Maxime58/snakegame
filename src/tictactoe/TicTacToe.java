...
public class TicTacToe {
    ...
    public static void main(String[] args) {
        ...
        first = new JLabel("Chose your player: ");
        first.setAlignmentX(Component.CENTER_ALIGNMENT);

        JPanel knopPanel = new JPanel();
        knopPanel.setLayout(new FlowLayout(FlowLayout.CENTER, 20, 20));
                ...
                gridButton.addActionListener(e -> {
                    if (gridButton.getText().equals("")) {
                        ...
                        if (checkWin(huidigeSpeler)) {
                            JOptionPane.showMessageDialog(frame, "Speler" + huidigeSpeler + "wint!");
                            blokkeerAlleKnoppen();
                        } else {
                            huidigeSpeler = (huidigeSpeler == 'X') ? 'O' : 'X';
                            seconde.setText("Beurt van speler: " + huidigeSpeler);
                        }
                    }
                });
